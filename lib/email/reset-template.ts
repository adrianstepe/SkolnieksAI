...
<head>
  ...
  <style>
    ...
    .warning { background: #fef3c7; border: none; border-left: 3px solid #2563EB; border-radius: 8px; padding: 12px 16px; margin-bottom: 24px; }
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <a href="${resetUrl}" class="cta">Mainīt paroli</a>
      <div class="url-fallback">
        <p>Ja poga nedarbojas, nokopē šo saiti pārlūkprogrammā:</p>
        <p>${resetUrl}</p>
      </div>
    </div>
    <div class="footer">
